...
import { RoleMaster, RoleMasterSchema, UserRoles, OrganizationMaster, OrganizationMasterSchema } from "./role-master";
...
import { Link, Node, prepareNodes, prepareDotNetLinks, NodeLinkType, _createNode, resetNodeAndLinkIndex } from "./nodes-and-links";

export {
    EntityBase, MultipleCollectionsConfig,
    UserMaster, UserMasterSchema,
    RoleMaster, RoleMasterSchema, UserRoles, OrganizationMaster, OrganizationMasterSchema,
    ...
    Link, Node, prepareNodes, prepareDotNetLinks, resetNodeAndLinkIndex, NodeLinkType, _createNode
};